window.APP_DATA = {
  subjects: {
    psycho: [
      ...
      {
        id: "psycho_14",
        question: "Parmi les prérequis à la communication, lequel est systématiquement déficitaire dans le TSA ?",
        options: [
          "A. La discrimination auditive fine",
          "B. L'attention conjointe",
          "C. La mémoire de travail phonologique",
          "D. La production articulatoire"
        ],
        correct: 1,
        explanation: "L'attention conjointe est systématiquement déficitaire dans le TSA et constitue un signe clinique précoce majeur. Les autres prérequis déficitaires incluent le contact visuel/poursuite oculaire, le pointage absent/inconstant, l'imitation pauvre, et l'absence de tour de rôle. La phonologie et l'articulation (C, D) sont souvent relativement préservées, et la discrimination auditive fine (A) n'est pas le prérequis le plus caractéristiquement atteint.",
      ...
      {
        id: "psycho_20",
        question: "Selon l'article de Simms & Jin (2015), quelle caractéristique différencie le Trouble de la Communication Sociale (Pragmatique) du TSA ?",
        options: [
    ...
    geronto: [
      {
        ...
        correct: 1,
        explanation: "La gériatrie est une spécialité médicale qui traite les maladies des personnes âgées (+75 ans en Belgique). Le gériatre est le « généraliste » de la personne âgée. La gérontologie est la science qui étudie le vieillissement sous tous ses aspects (sociaux, démographiques, économiques, culturels, médicaux). Le gérontologue n'est pas nécessairement médecin. Ces termes ne sont PAS interchangeables.",
      ...
      {
        id: "geronto_10",
        question: "Parmi les 5 critères du phénotype de Fried, lequel évalue la vitesse de marche ?",
        options: [
          "A. La faiblesse (grip strength)",
          "B. La sédentarité",
          "C. La lenteur : marche de 4 mètres en plus de 4 secondes",
          "D. L'épuisement (fatigue auto-rapportée)"
        ],
        correct: 2,
        explanation: "Le critère de lenteur du phénotype de Fried évalue la vitesse de marche : plus de 4 secondes pour parcourir 4 mètres. Les 5 critères de Fried sont : (1) perte de poids involontaire >4,5 kg ou ≥5% en 1 an, (2) épuisement (fatigue auto-rapportée), (3) faiblesse (force de préhension au dynamomètre), (4) lenteur (vitesse de marche), (5) sédentarité (activité physique basse).",
        source: "Gériatrie - Notes de cours",
        difficulty: "medium"
      },
      {
        id: "geronto_11",
        question: "Selon le phénotype de Fried, un score de 3 critères sur 5 correspond à :",
        options: [
          "A. Robuste",
          "B. Pré-fragile",
          "C. Fragile",
      ...
      {
        id: "geronto_13",
        question: "Quel est un avantage de l'indice de fragilité de Rockwood par rapport au phénotype de Fried ?",
        options: [
      ...
      },
      {
        ...
        correct: 3,
        explanation: "L'indice de fragilité de Rockwood couvre 9 domaines : Cognition, Humeur, Motivation, Motricité, Équilibre, AVQ (Activités de la Vie Quotidienne), Nutrition, Social, Comorbidités. Il comprend 70 à 100 variables réparties dans ces domaines, avec un score calculé comme le nombre de déficits divisé par le nombre total d'items.",
        source: "Gériatrie - Notes de cours",
        difficulty: "hard"
      },
      {
        id: "geronto_15",
        question: "Quelle est la durée approximative d'administration du phénotype de Fried versus l'indice de Rockwood ?",
        options: [
      ...
      {
        id: "geronto_17",
        question: "Quels sont les rôles-clés du logopède dans l'équipe multidisciplinaire gériatrique ?",
        options: [
          "A. Prescrire, diagnostiquer, opérer",
          "B. Identifier, évaluer, intervenir, informer, collaborer, former/éduquer",
          "C. Animer, divertir, accompagner",
          "D. Administrer, gérer, coordonner les soins infirmiers"
        ],
        correct: 1,
        explanation: "Les rôles-clés du logopède dans l'équipe multidisciplinaire gériatrique sont : Identifier, Évaluer, Intervenir, Informer, Collaborer, Former/Éduquer. Le PIL (Projet d'Intervention Logopédique) peut être restaurateur, réorganisateur ou palliatif, en approche directe ou indirecte.",
        source: "Gériatrie - Notes de cours",
        difficulty: "medium"
      },
      {
      ...
      {
        id: "geronto_24",
        question: "Que signifie l'acronyme CGA (Comprehensive Geriatric Assessment) en français ?",
        options: [
      ...
      {
        id: "geronto_25",
        question: "Parmi les syndromes gériatriques les plus fréquents, lequel est défini comme un état confusionnel aigu ?",
        options: [
          "A. L'incontinence",
        ...
        correct: 2,
        explanation: "Parmi les syndromes gériatriques les plus fréquents, le delirium correspond à un état confusionnel aigu. Les autres syndromes fréquents sont les chutes, l'incontinence et l'hypotension orthostatique. Ces syndromes sont des conditions cliniques qui ne correspondent pas aux catégories de maladies classiques.",
        source: "Gériatrie - Notes de cours",
        difficulty: "easy"
      }
    ],
    audio: [
      {
        ...
        correct: 1,
        explanation: "Selon les données de l'OMS (2021), 466 millions de personnes dans le monde présentent une perte auditive, dont 34 millions d'enfants. En Belgique, environ 1 million de personnes sont concernées sur une population de 11 millions.",
      ...
      {
        id: "audio_12",
        question: "Quel syndrome associe une surdité congénitale profonde, des troubles de l'équilibre et une rétinite pigmentaire évoluant vers la cécité ?",
        options: [
      ...
      {
        id: "audio_18",
        question: "À quel âge (période) une surdité est-elle dite « prélinguale » ?",
        options: [
      ...
      {
        id: "audio_24",
        question: "Quelles sont les 4 causes de surdité acquise listées dans le cours ?",
        options: [
          "A. Traumatique, infectieuse, médicamenteuse, liée à l'âge",
          "B. Génétique, congénitale, héréditaire, familiale",
          "C. Vasculaire, métabolique, endocrinienne, nutritionnelle",
          "D. Psychologique, sociale, culturelle, environnementale"
        ],
        correct: 0,
        explanation: "Les 4 causes de surdité acquise sont : (1) traumatique (bruit, accident, stress, explosion), (2) infectieuse (méningite, encéphalite, oreillons, Ménière), (3) médicamenteuse (ototoxicité), (4) liée à l'âge (presbyacousie). S'y ajoutent les causes tumorales (neurinome du VIII) et psychologiques (surdité brutale).",
        source: "Les Surdités - Module 1",
        difficulty: "medium"
      },
      {
  ...
  clinicalCases: {
    inter: [
      {
        ...
        anamnese: "Léo est le deuxième enfant de parents entendants, sans antécédents familiaux de surdité. La grossesse et l'accouchement se sont déroulés sans particularité. Les parents rapportent que Léo était un bébé « très calme », ne pleurait jamais, ne babillait pas à 10 mois. Il n'a pas réagi aux tests de dépistage auditif néonatal — mais les parents pensaient que c'était dû à son « caractère calme ». À 4 ans, Léo ne parle pas, ne répond pas à son prénom, évite le contact visuel, présente des balancements stéréotypés et s'intéresse exclusivement aux objets qui tournent. Il ne pointe pas et ne montre aucune attention conjointe. Le pédiatre évoque un TSA. Un bilan ORL révèle une surdité de perception bilatérale profonde (95 dB de perte moyenne).",
          questions: [
            {
              question: "Quels signes chez Léo pourraient relever UNIQUEMENT de sa surdité et non d'un TSA ?",
              options: [
                "A. L'évitement du regard et l'absence de pointage",
                "B. L'absence de babillage et l'absence de réponse au prénom",
                "C. Les balancements stéréotypés et l'intérêt exclusif pour les objets qui tournent",
                "D. Le fait d'être un bébé « très calme » et l'absence de pleurs"
              ],
              correct: 1,
              explanation: "L'absence de babillage à 10 mois et l'absence de réponse au prénom sont des conséquences directes et attendues d'une surdité profonde bilatérale non appareillée, car l'enfant n'a pas accès au feedback auditif ni aux stimulations sonores. Les balancements stéréotypés (C), l'intérêt restreint et l'évitement du regard (A) sont davantage évocateurs d'un TSA. Le caractère « très calme » (D) peut relever des deux conditions.",
              source: "TSA Partie 1 & Les Surdités - Module 1"
            },
            {
              question: "Sachant que le taux de TSA dans la population sourde est de 4% (Meinzen-Derr, 2013), quel élément doit alerter sur un possible double diagnostic chez Léo ?",
              options: [
                "A. La surdité profonde bilatérale",
                "B. L'absence d'attention conjointe, les stéréotypies motrices et l'intérêt restreint aux objets qui tournent",
                "C. L'absence de babillage à 10 mois",
                "D. Le fait d'avoir des parents entendants"
              ],
              correct: 1,
              explanation: "L'absence d'attention conjointe, les stéréotypies motrices (balancements) et les intérêts restreints (objets qui tournent) sont des signes cardinaux du TSA selon les critères DSM-5 (critères A et B) qui ne sont pas expliqués par la surdité seule. Selon Meinzen-Derr (2013), le diagnostic de TSA chez l'enfant sourd est tardif et délicat. Les étiologies communes (CMV, rubéole, prématurité) sont retrouvées dans 50% des cas de double diagnostic.",
              source: "Les Surdités - Module 1 & TSA Partie 1"
            },
            {
              question: "Dans le cadre d'un double diagnostic TSA + surdité profonde, quel outil d'évaluation logopédique serait le plus adapté pour évaluer la communication réceptive de Léo et orienter le choix d'un moyen de CAA ?",
              options: [
                "A. L'ADOS-2",
                "B. Le ComVoor (ComFor-2)",
                "C. Le CHAT",
              ...
              correct: 1,
              explanation: "Le ComVoor (ComFor-2) est spécifiquement conçu pour évaluer la communication réceptive chez les personnes non verbales ou à faible niveau verbal avec autisme. Il cible le niveau de représentation visuelle et aide à choisir la complexité appropriée du moyen de CAA. L'ADOS-2 (A) est un outil d'observation diagnostique, le CHAT (C) est un dépistage précoce, et le VB-MAPP (D) évalue des compétences linguistiques et sociales plus larges.",
              source: "TSA Partie 2 - Communication & Habiletés sociales"
            }
          ],
        analysis: "Le cas de Léo illustre la complexité du double diagnostic TSA + surdité. Le taux de TSA est 4 fois plus élevé dans la population sourde (4% vs 1%). Le diagnostic de TSA est tardif et délicat car certains signes se chevauchent (absence de réponse au nom, retard de langage). Les signes spécifiques du TSA qui ne s'expliquent PAS par la surdité sont : l'absence d'attention conjointe, les intérêts restreints, les stéréotypies motrices, et l'évitement du regard. L'enjeu est d'appareiller précocement (IC bilatérale vu la profondeur) TOUT EN mettant en place des stratégies de CAA adaptées via le ComVoor, et en travaillant les prérequis à la communication (attention conjointe, pointage, imitation) par des approches visuelles et structurées. 95% des enfants sourds ont des parents entendants, ce qui complexifie l'accompagnement familial déjà mis à l'épreuve par le double handicap.",
        sources: ["TSA Partie 1", "TSA Partie 2 - Communication & Habiletés sociales", "Les Surdités - Module 1"]
      },
      {
        id: "inter_02",
        ...
        anamnese: "Mme Vandenberghe, 78 ans, est veuve depuis 5 ans et vit seule dans un appartement au 1er étage sans ascenseur. Elle présente un diabète de type 2, une HTA traitée et une gonarthrose. Depuis environ 18 mois, sa fille rapporte que sa mère se plaint de « ne plus comprendre ce qu'on lui dit », fait répéter constamment, a cessé d'aller au club de bridge qu'elle affectionnait, et refuse les invitations familiales. Elle semble « ailleurs » pendant les conversations. Sa fille a remarqué qu'elle augmente systématiquement le volume de la télévision. Le médecin traitant évoque un possible déclin cognitif débutant. Au test de Fried : perte de poids de 4 kg en 1 an (58→54 kg), fatigue auto-rapportée, marche 4 mètres en 5 secondes. Un audiogramme révèle une perte auditive neurosensorielle bilatérale de 55 dB en moyenne sur les fréquences conversationnelles, compatible avec une presbyacousie.",
          questions: [
            {
              question: "Quel score au phénotype de Fried Mme Vandenberghe présente-t-elle et comment est-elle classifiée ?",
              options: [
                "A. 1/5 — Robuste",
                "B. 3/5 — Fragile",
                "C. 2/5 — Pré-fragile",
            ...
            {
              question: "Quelle approche interdisciplinaire est la plus appropriée pour Mme Vandenberghe ?",
              options: [
                "A. Appareillage auditif seul, sans autre intervention",
                "B. Évaluation gériatrique multidimensionnelle (EGM) avec bilan ORL, logopédique, neuropsychologique et social, appareillage auditif, et suivi en équipe multidisciplinaire",
                "C. Placement immédiat en maison de repos",
                "D. Traitement médicamenteux pour le déclin cognitif sans appareillage"
              ],
              correct: 1,
              explanation: "Mme Vandenberghe relève d'une approche interdisciplinaire complète associant EGM, bilan ORL (appareillage pour presbyacousie), bilan logopédique (communication, éventuelle déglutition), bilan neuropsychologique (évaluation cognitive différentielle avant/après appareillage), et évaluation sociale (isolement, perte d'autonomie). L'EGM + équipe multidisciplinaire réduisent la mortalité, l'institutionnalisation et le déclin fonctionnel. L'appareillage précoce est essentiel.",
              source: "Gériatrie - Notes de cours & Les Surdités - Module 1"
            }
          ],
        analysis: "Ce cas illustre le lien bidirectionnel entre presbyacousie, fragilité et isolement social chez la personne âgée. La perte auditive neurosensorielle bilatérale de 55 dB est une presbyacousie non appareillée qui a conduit à un retrait social progressif (arrêt du bridge, refus familial), un isolement qui aggrave la fragilité physique (perte de poids, fatigue, ralentissement moteur) et peut mimer un déclin cognitif. L'âgisme « bienveillant » (parler plus fort, phrases simplifiées) peut paradoxalement diminuer ses performances et renforcer son retrait. L'approche interdisciplinaire (EGM + ORL + logopédie + neuropsychologie) est indispensable pour démêler ce qui relève de la presbyacousie, du déclin cognitif éventuel et de la fragilité, et pour proposer un PIL adapté (approche restauratrice pour la communication, réorganisatrice via l'appareillage, et préventive pour la fragilité).",
      ...
      },
      {
        ...
        anamnese: "M. Lefebvre, 82 ans, ancien professeur de mathématiques, est suivi pour une maladie de Parkinson diagnostiquée il y a 6 ans. Il vit avec son épouse de 78 ans dans une maison à deux étages. Il présente une bradykinésie, une rigidité, des troubles de la marche et une hypophonie croissante. Depuis 6 mois, son épouse rapporte qu'il « s'étouffe » fréquemment pendant les repas, tousse en buvant, et a perdu 6 kg (68→62 kg). Il refuse de voir ses anciens collègues, se dit « honteux » de sa voix et de ses difficultés à manger. Il n'a plus d'appétit. Son traitement parkinsonien est bien suivi. Fried : perte de poids >4,5 kg, fatigue, lenteur (marche 4m en 7s), faiblesse (grip 18/16 kg), sédentarité. Albuminémie à 30 g/L.",
          questions: [
            {
              question: "M. Lefebvre présente 5 critères de Fried sur 5. Quel est son statut ?",
              options: [
                "A. Robuste",
                "B. Pré-fragile",
                "C. Fragile",
              ...
              correct: 2,
              explanation: "Avec 5 critères de Fried sur 5 (perte de poids, fatigue, lenteur, faiblesse, sédentarité), M. Lefebvre est classé « fragile ». Le phénotype de Fried ne comporte pas de catégorie « très fragile » (c'est l'indice de Rockwood qui inclut cette catégorie avec un score >0,45). Le score ≥3 = fragile.",
              source: "Gériatrie - Notes de cours"
            },
            {
        ...
        analysis: "Ce cas démontre l'intrication entre une pathologie neurodégénérative (Parkinson), les troubles de la communication et de la déglutition, et la fragilité gériatrique. La dysphagie correspond à la définition d'un syndrome gériatrique : prévalence qui augmente avec l'âge, origine plurifactorielle, et plainte principale (« honte », perte d'appétit) qui masque la condition sous-jacente (fausses routes, dénutrition). Le score de Fried à 5/5 et l'albumine à 30 g/L objectivent une dénutrition sévère. La fragilité est potentiellement réversible si une prise en charge multidisciplinaire est instaurée : logopédie (déglutition + voix), diététique, kinésithérapie, soutien psychologique, et adaptation du domicile. L'EGM est indispensable pour évaluer l'ensemble des domaines (cognition, humeur, nutrition, AVQ, social).",
        sources: ["Gériatrie - Notes de cours", "TSA Partie 2 - Communication & Habiletés sociales"]
      }
    ],
    ...
    audioReed: [
      {
        id: "audio_reed_01",
        title: "Emma, 18 mois : surdité de perception bilatérale profonde",
        audiogramDescription: "Audiométrie tonale : pas de réponse aux fréquences 250-4000 Hz jusqu'à 100 dB en conduction aérienne et osseuse. Les potentiels évoqués auditifs (PEA) confirment une absence de réponse à 95 dB, compatible avec une surdité de perception bilatérale profonde.",
        hearingLoss: { type: "Perception (neurosensorielle) bilatérale", degree: "Profonde", ear: "Bilatérale", averageLoss: ">100 dB" },
        questions: [
          {
            question: "À quel âge d'apparition cette surdité correspond-elle et quelles en sont les conséquences développementales immédiates ?",
            options: [
            ...
            correct: 1,
            explanation: "Il s'agit d'une surdité prélinguale (de naissance), survenant avant l'acquisition du langage. Les conséquences développementales immédiates incluent l'absence de babillage (6-12 mois), l'absence de dialogue tonique, l'absence d'attention conjointe, et l'absence de précurseurs du langage (12-24 mois). Une prise en charge précoce est cruciale.",
            source: "Les Surdités - Module 1"
          },
          {
            question: "Quel type d'appareillage est le plus indiqué pour Emma et pourquoi ?",
            options: [
        ...
        reeducation: {
          goals: [
            "Établir une communication fonctionnelle via le canal visuel et vibrotactile en attendant l'implantation cochléaire",
            "Développer les précurseurs à la communication : attention conjointe, tour de rôle, pointage, imitation",
            "Favoriser l'émergence du babillage et des premières productions vocales après implantation",
            "Accompagner les parents (95% des parents d'enfants sourds sont entendants) dans la mise en place d'une communication multimodale (LSFB, LPC, oral)"
          ],
          methods: [
            "Stimulation auditive précoce post-IC : entraînement à la détection, discrimination, identification et compréhension des sons",
            "Travail sur le rythme, la prosodie et la perception phonémique via des jeux sonores adaptés",
            "Utilisation du LPC (Langue française Parlée Complétée) pour soutenir le développement phonologique",
            "Approche multimodale : support visuel (pictogrammes, gestes), vibrotactile (percussions corporelles), et auditif",
            "Séances conjointes parents-enfant pour favoriser le bain de langage adapté"
          ],
          adaptations: [
            "Environnement calme et favorable à l'écoute (réduction du bruit de fond, tapis, rideaux)",
            "Positionnement face à l'enfant pour favoriser la lecture labiale et les expressions faciales",
            "Vérification régulière du bon fonctionnement de l'IC (piles, processeur, antenne)",
            "Adaptation du débit et de l'intensité de la parole en fonction des réglages de l'IC",
            "Coordination étroite avec l'équipe pluridisciplinaire : ORL, audioprothésiste, psychomotricien, psychologue"
          ]
        }
      },
      {
        id: "audio_reed_02",
        title: "Lucas, 6 ans : surdité de perception bilatérale sévère d'origine génétique (Connexine 26)",
        audiogramDescription: "Audiométrie tonale : courbe descendante bilatérale en conduction aérienne et osseuse. Seuils : 60 dB à 500 Hz, 70 dB à 1000 Hz, 80 dB à 2000 Hz, 90 dB à 4000 Hz. Perte moyenne = (60+70+80+90)/4 = 75 dB. Surdité de perception sévère du 1er degré. Rinne absent. L'enfant est appareillé bilatéralement depuis l'âge de 10 mois.",
        hearingLoss: { type: "Perception (neurosensorielle) bilatérale", degree: "Sévère 1er degré", ear: "Bilatérale", averageLoss: "75 dB" },
        questions: [
          {
            question: "Selon la classification BIAP, une perte moyenne de 75 dB correspond à :",
            options: [
              "A. Une surdité moyenne du 2e degré (56-70 dB)",
              "B. Une surdité sévère du 1er degré (71-80 dB)",
              "C. Une surdité sévère du 2e degré (81-90 dB)",
              "D. Une surdité profonde (91-120 dB)"
            ],
            correct: 1,
            explanation: "Selon la classification BIAP, une perte moyenne de 75 dB correspond à la surdité sévère du 1er degré (71-80 dB). La surdité sévère du 2e degré va de 81 à 90 dB. Le calcul est correct : (60+70+80+90)/4 = 75 dB en conduction aérienne, courbe uniforme, par oreille.",
            source: "Les Surdités - Module 1"
          },
          {
        ...
        reeducation: {
          goals: [
            "Développer la perception et la discrimination auditive fine des phonèmes avec l'appareillage",
            "Enrichir le stock lexical et les représentations phonologiques",
            "Travailler la compréhension en environnement bruyant (déficit de filtrage du bruit de fond selon Zilbovicus et al., 2000)",
            "Développer les compétences narratives et la pragmatique du langage",
            "Prévenir les difficultés d'apprentissage scolaire (lecture, écriture) liées aux confusions phonémiques"
          ],
          methods: [
            "Entraînement auditif structuré : détection, discrimination, identification, compréhension (niveaux hiérarchiques)",
            "Travail phonologique ciblé sur les confusions liées à la courbe descendante (fricatives aiguës /f/, /s/, /ch/)",
            "Exercices de compréhension en bruit de fond croissant (filtrage des bruits parasites)",
            "Utilisation du LPC en complément pour sécuriser les représentations phonologiques",
            "Lecture partagée et narration pour développer le langage élaboré et la compréhension de texte"
          ],
          adaptations: [
            "Placement préférentiel en classe (devant, proche de l'enseignant)",
            "Utilisation d'un système MF (microphone-émetteur pour l'enseignant)",
            "Vérification quotidienne du bon fonctionnement des appareils auditifs par les parents/enseignant",
            "Supports visuels en classe (écrits, schémas, pictogrammes) pour compléter l'information auditive",
            "Sensibilisation des camarades de classe et de l'équipe éducative aux besoins spécifiques de Lucas"
          ]
        }
      }
    ],
    ...
    fragilite: [
      {
        ...
        anamnese: "M. Dubois, 76 ans, a chuté il y a 2 jours en allant aux toilettes la nuit. Il présente une HTA traitée, une hypercholestérolémie et une arthrose des genoux. Il vit avec son épouse dans une maison de plain-pied. Il marche avec une canne depuis 1 an. Son poids est passé de 72 à 77 puis 78 kg (prise de poids, pas de perte). Son épouse signale qu'il « ralentit », se fatigue plus vite, mais qu'il a « bon appétit ». Test de marche : 4 mètres en 6 secondes avec canne. Force de préhension : 27/26 kg (normale pour l'âge).",
          questions: [
            {
              question: "Quel score de Fried et quel statut pour M. Dubois ?",
              options: [
                "A. 3/5 — Fragile",
                "B. 2/5 — Pré-fragile",
                "C. 5/5 — Fragile",
              ...
              correct: 1,
              explanation: "M. Dubois présente 2 critères : (1) lenteur (marche 4m en 6s > 4s), (2) fatigue auto-rapportée. Il n'a PAS de perte de poids (prise de poids au contraire), sa force de préhension est normale (27/26 kg), et la sédentarité n'est pas documentée. Score 2/5 = pré-fragile. La chute n'est pas un critère de Fried mais peut être un syndrome gériatrique.",
              source: "Gériatrie - Notes de cours & Vignettes cliniques - Fragilité"
            },
            {
              question: "Quel est le problème sous-jacent le plus probable chez M. Dubois ?",
              options: [
                "A. Un syndrome démentiel avancé",
                "B. Un vertige (cause de la chute) et un début de fragilité",
                "C. Une dépression sévère",
                "D. Une dénutrition protéino-énergétique"
              ],
              correct: 1,
              explanation: "La chute nocturne (en allant aux toilettes) évoque un vertige ou une hypotension orthostatique. Le ralentissement et la fatigue sont des signes de début de fragilité. La prise de poids et le bon appétit écartent la dénutrition (D). Aucun signe de démence ou de dépression n'est rapporté (A, C). Le retour à domicile est acceptable mais nécessite un hôpital de jour gériatrique pour évaluation complète.",
              source: "Gériatrie - Notes de cours & Vignettes cliniques - Fragilité"
            }
          ],
        analysis: "M. Dubois est classé pré-fragile (2 critères de Fried). La fragilité étant un processus dynamique et potentiellement réversible, une intervention précoce en HDJ gériatrique est indiquée pour : (1) investiguer la cause de la chute (vertige, hypotension orthostatique ?), (2) prévenir la transition vers la fragilité, (3) adapter l'environnement (sécurisation du trajet lit-toilettes la nuit). Le maintien à domicile est acceptable à ce stade.",
        sources: ["Gériatrie - Notes de cours", "Vignettes cliniques - Fragilité"]
      },
      {
        id: "frag_02",
        ...
        anamnese: "Mme Garcia, 81 ans, a présenté une gastro-entérite il y a 10 jours. Elle vit seule dans un appartement au 2e étage sans ascenseur. Veuve depuis 3 ans, elle était très proche de son mari. Antécédents : diabète de type 2, hypothyroïdie, gonarthrose bilatérale. Son poids est passé de 61-62 kg à 56 kg actuellement. Albumine à 33 g/L. Sa fille rapporte qu'elle ne s'alimente plus que de plats préparés, qu'elle a été retrouvée assise par terre dans la cuisine (incapable de se relever seule), refuse toute aide, et voit de moins en moins ses amies. Fried : perte de poids (>4,5 kg), fatigue, faiblesse, lenteur, sédentarité — score 5/5.",
          questions: [
            {
              question: "À quel état correspond le tableau de Mme Garcia (5 critères de Fried, albumine basse, repli social, refus d'aide) ?",
              options: [
                "A. Un vieillissement normal et réussi",
                "B. Une fragilité sévère évoquant un syndrome de glissement",
                "C. Une pré-fragilité réversible",
                "D. Un état robuste avec un épisode aigu bénin"
              ],
              correct: 1,
              explanation: "Le tableau de Mme Garcia associe 5 critères de Fried (fragile), une albumine à 33 g/L (dénutrition débutante), un repli social, un refus d'aide et une perte d'élan vital après le décès de son mari, évoquant un syndrome de glissement. Le retour à domicile est DANGEREUX dans ces conditions.",
              source: "Gériatrie - Notes de cours & Vignettes cliniques - Fragilité"
            },
            {
              question: "Quelle orientation est la plus adaptée pour Mme Garcia ?",
              options: [
        ...
        analysis: "Mme Garcia présente une fragilité sévère (5 critères de Fried) avec un tableau de syndrome de glissement post-deuil (veuve depuis 3 ans, mari très proche). Le facteur déclenchant aigu (gastro-entérite) a décompensé un état de fragilité sous-jacent. La perte d'autonomie fonctionnelle (incapable de se relever), la dénutrition (albumine 33 g/L, poids 56 kg), le repli social et le refus d'aide rendent le retour à domicile dangereux. Une prise en charge en SSR gériatrique avec EGM et équipe pluridisciplinaire est indispensable. La fragilité étant potentiellement réversible, une intervention intensive peut permettre une récupération.",
        sources: ["Gériatrie - Notes de cours", "Vignettes cliniques - Fragilité"]
      },
      {
        id: "frag_03",
        ...
        anamnese: "M. Leroy, 79 ans, est hospitalisé pour une exacerbation de BPCO avec fibrillation auriculaire. Il vit avec son épouse dans une maison à deux étages. Il a arrêté la kinésithérapie respiratoire il y a 6 mois, la jugeant « trop fatigante ». Son poids est passé de 67 à 65 puis 62 puis 58 kg (perte de 9 kg en 1 an). Son épouse signale des « fausses routes » récurrentes aux liquides. Force de préhension : 22/20 kg (faible). Test de marche : lenteur marquée (non chronométrée). Fried : 5/5. Problème sous-jacent identifié : fragilité sévère + BPCO décompensée. Réversibilité jugée LIMITÉE.",
          questions: [
            ...
            },
            {
              ...
              correct: 1,
              explanation: "Le logopède intervient sur les fausses routes (dysphagie) signalées par l'épouse : évaluation de la déglutition, adaptation des textures et des postures, stratégies de compensation, conseils à l'entourage. La coordination avec la diététicienne est essentielle pour lutter contre la dénutrition (perte de 9 kg, albumine probablement basse). Les rôles-clés incluent aussi l'information et la formation de l'équipe.",
              source: "Gériatrie - Notes de cours"
            }
          ],
        analysis: "M. Leroy présente une fragilité sévère (5/5 au Fried) compliquant une BPCO décompensée. Les fausses routes rapportées aggravent la dénutrition (perte de 9 kg) et créent un risque de pneumopathie d'inhalation. L'arrêt de la kinésithérapie par fatigue illustre le cercle vicieux fragilité-maladie chronique. La réversibilité est jugée LIMITÉE par rapport aux cas précédents en raison de la pathologie respiratoire chronique sévère. L'orientation recommandée est un SSR pneumo-gériatrique pour une prise en charge conjointe pneumologique et gériatrique, incluant logopédie (dysphagie), kinésithérapie respiratoire adaptée et diététique.",
        sources: ["Gériatrie - Notes de cours", "Vignettes cliniques - Fragilité"]
      }
    ]
  },
  ...
  sources: {
    "TSA Partie 1": "Psycho/1 A TSA PARTIE 1 2026 ETUDIANT.pptx",
    "TSA Partie 2 - Communication & Habiletés sociales": "Psycho/1 B TSA PARTIE 2 2026 ETUDIANT.pptx",
    "Autism, Language Disorder, and Social (Pragmatic) Communication Disorder (Simms & Jin, 2015)": "Psycho/Texte Autisme, TDL, tr pragmatique",
    "Gériatrie - Notes de cours": "Gériatrie UE 320.docx",
    "Gérontologie - Cours 1 (L. Lieffrig)": "Géronto- Cours 1.pptx - Dernier enregistrement par lâ•Žutilisateur.pdf",
    "Vignettes cliniques - Fragilité": "vignettes_fragilite patients_etudiants.pdf",
    "Les Surdités - Module 1": "2526_module 1_surdites.pdf",
    "UE310 Surdités - Notes": "UE310 Surdités.docx",
    "TSA Partie 1 & Les Surdités - Module 1": "Psycho/1 A TSA PARTIE 1 2026 ETUDIANT.pptx, 2526_module 1_surdites.pdf",
    "Les Surdités - Module 1 & TSA Partie 1": "2526_module 1_surdites.pdf, Psycho/1 A TSA PARTIE 1 2026 ETUDIANT.pptx",
    "Gériatrie - Notes de cours & Vignettes cliniques - Fragilité": "Gériatrie UE 320.docx, vignettes_fragilite patients_etudiants.pdf",
    "Gériatrie - Notes de cours & Les Surdités - Module 1": "Gériatrie UE 320.docx, 2526_module 1_surdites.pdf",
    "Les Surdités - Module 1 & Gériatrie - Notes de cours": "2526_module 1_surdites.pdf, Gériatrie UE 320.docx"
  }
};
